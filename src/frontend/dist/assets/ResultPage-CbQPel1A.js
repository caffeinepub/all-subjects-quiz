import { c as createLucideIcon, u as useApp, j as jsxRuntimeExports, T as Trophy, i as Star, d as Badge, B as Button } from "./index-Bj33dnLh.js";
...
function ResultPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "min-h-screen bg-gray-50 py-6 sm:py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 sm:px-6", children: [
    ...
    quizResult.detailedResults.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl shadow-card p-6 mb-5", children: [
