...
export class Backend implements backendInterface {
    ...
    async getSubjectQuizzes(arg0: bigint): Promise<Array<Quiz>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSubjectQuizzes(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitQuizAnswers(arg0: bigint, arg1: Array<Answer>): Promise<QuizResult> {
        if (this.processError) {
            try {
